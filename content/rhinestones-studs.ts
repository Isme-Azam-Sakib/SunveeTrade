...
export const rhinestonesStuds: ProductLine = {
  ...
  categories: [
    {
      slug: "hot-fix-rhinestones",
      name: "Hot-fix rhinestones & motifs",
      summary:
        "Machine-cut, Korean AAA, shaped stones and ceramic hot-fix rhinestones with heat-activated adhesive backing.",
      items: [
        {
          slug: "premium-m-c-rhinestone",
          name: "Premium M/C Rhinestone",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/premium-m-c-rhinestone/1.jpg", alt: "PREMIUM MC RHINESTONE" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
          ],
        },
        {
          slug: "machine-cut-shape-stone",
          name: "Machine Cut Shape Stone",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/machine-cut-shape-stone/1.jpg", alt: "MC SHAPE STONE" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/rhinestone-a/1.jpg", alt: "RHINESTONE(A)" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/shape-stone-a/1.jpg", alt: "SHAPE STONE(A)" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/ceramic-stone/1.jpg", alt: "CERAMIC STONE" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/new-rhinestone/1.jpg", alt: "NEW RHINESSTONE" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        {
          slug: "ring-stone-rhinestone-a",
          name: "Ring Stone + Rhinestone(A)",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/ring-stone-rhinestone-a/1.jpg", alt: "RING STONE" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/octagon/1.jpg", alt: "OCTAGON" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/stone-mesh/1.jpg", alt: "STONE MESH" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/metal-mesh/1.jpg", alt: "METAL MESH" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/laser-cut/1.jpg", alt: "LASER CUT" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/wheel/1.jpg", alt: "WHEEL" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        {
          slug: "pp-stone-sheet-type-1",
          name: "PP Stone Sheet Type 1",
        ...
        {
          slug: "pp-stone-sheet-type-2",
          name: "PP Stone Sheet Type 2",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/pp-stone-sheet-type-2/1.jpg", alt: "PP STONE SHEET TYPE 2" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/hot-fix-rhinestones/rim/1.jpg", alt: "Rim Metal Hot Fix" },
          ],
          specs: [
            { label: "Adhesion", value: "Tested to 10 washes" },
            { label: "Eco Standard", value: "Nickel, Lead & Cadmium free" },
    ...
    {
      slug: "metal-studs",
      name: "Metal studs & nailheads",
      summary:
        "Standard nickel, lead, cadmium & magnet free metal studs, nailheads, and antique finishes tested to 10 washes.",
      items: [
        {
          slug: "nailhead",
          name: "Nailhead",
          ...
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
          ],
        },
        {
          slug: "nailhead-check",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/metal-studs/nailhead-check/1.jpg", alt: "NAILHEAD CHECK" },
          ],
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
        ...
        {
          slug: "nailhead-others",
          name: "Nailhead Others",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/metal-studs/nailhead-others/1.jpg", alt: "NAILHEAD OTHERS" },
          ],
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/metal-studs/antique-metal/1.jpg", alt: "ANTIQUE METAL" },
          ],
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/metal-studs/convex-i/1.jpg", alt: "CONVEX I" },
          ],
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/metal-studs/abs-stud/1.jpg", alt: "ABS STUD" },
          ],
          specs: [
            { label: "Material", value: "Brass / Alloy / ABS" },
            { label: "Compliance", value: "Magnet & Nickel Free" },
    ...
    {
      slug: "sew-on-stones",
      name: "Sew-on stones & cup chains",
      summary:
        "Faceted chaton stones, pronged metal cap stones, and continuous brass cup chains for direct garment attachment.",
      items: [
        {
          slug: "chaton-stone",
          name: "Chaton Stone",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/sew-on-stones/chaton-stone/1.jpg", alt: "CHATON STONE" },
          ],
          specs: [
            { label: "Mounting", value: "Prong set or sew hole" },
            { label: "Finish", value: "High-sparkle multi-facet" },
          ],
        },
        {
          slug: "chaton-stone-with-metal-cap",
          name: "Chaton Stone with Metal Cap",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/sew-on-stones/chaton-stone-with-metal-cap/1.jpg", alt: "CHATON STONE WITH METAL CAP" },
          ],
          specs: [
            { label: "Mounting", value: "Prong set or sew hole" },
            { label: "Finish", value: "High-sparkle multi-facet" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/sew-on-stones/sew-on-stone/1.jpg", alt: "SEW ON STONE" },
          ],
          specs: [
            { label: "Mounting", value: "Prong set or sew hole" },
            { label: "Finish", value: "High-sparkle multi-facet" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/sew-on-stones/cup-stone/1.jpg", alt: "CUP STONE" },
          ],
          specs: [
            { label: "Mounting", value: "Prong set or sew hole" },
            { label: "Finish", value: "High-sparkle multi-facet" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/sew-on-stones/cup-chain/1.jpg", alt: "CUP CHAIN" },
          ],
          specs: [
            { label: "Mounting", value: "Prong set or sew hole" },
            { label: "Finish", value: "High-sparkle multi-facet" },
    ...
    {
      slug: "transfer-films",
      name: "Heat transfer & motif films",
      summary:
        "Specialty films including glitter, flock, solid, metallic, and holographic effects for multi-media garment motifs.",
      items: [
        {
          slug: "glitter",
          name: "Glitter",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/glitter/1.jpg", alt: "GLITTER" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
          ],
        },
        {
          slug: "solid",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/solid/1.jpg", alt: "SOLID" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/flock/1.jpg", alt: "FLOCK" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/metallic/1.jpg", alt: "METALLIC" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/holographic/1.jpg", alt: "HOLOGRAPHIC" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
        ...
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/transfer-films/design/1.jpg", alt: "DESIGN" },
          ],
          specs: [
            { label: "Application", value: "Heat press transfer" },
            { label: "Washability", value: "High durability" },
    ...
    {
      slug: "application-accessories",
      name: "Carrier tapes & accessories",
      summary:
        "High-tack hot-fix silicone carrier tapes and embossing papers engineered for stable motif transfer.",
      items: [
        {
          slug: "hot-fix-tape",
          name: "Hot Fix Tape",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/application-accessories/hot-fix-tape/1.jpg", alt: "HOT FIX TAPE" },
          ],
          specs: [
            { label: "Temperature resistance", value: "Up to 200°C" },
          ],
        },
        {
          slug: "embo-paper",
          ...
          images: [
            { key: "product-lines/rhinestones-studs/application-accessories/embo-paper/1.jpg", alt: "EMBO PAPER" },
          ],
          specs: [
            { label: "Temperature resistance", value: "Up to 200°C" },
          ],
        },
        {
          ...
          images: [
            { key: "product-lines/rhinestones-studs/application-accessories/catalog/1.png", alt: "6 trial" },
          ],
          specs: [
            { label: "Temperature resistance", value: "Up to 200°C" },
          ],
